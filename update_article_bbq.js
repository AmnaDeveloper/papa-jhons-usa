...
const existingIndex = data.findIndex(p => p.slug === 'bbq-chicken-bacon-pizza');

const newItem = {
    "id": "item-6",
    "slug": "bbq-chicken-bacon-pizza",
    "category": "Super Loaded",
    "title": "Papa Johns BBQ Chicken Bacon Pizza 2026: Toppings, Price, Calories & Honest Review",
    "description": "Papa Johns BBQ Chicken Bacon Pizza — full 2026 price guide ($14.49–$23.99), calories per slice, toppings breakdown, vs Domino's & Pizza Hut + ranch sauce pairing tip.",
    "fullContent": `
...
<p class="mt-4">📌 <strong>Nutrition notes:</strong></p>
<ul>
...
<li>Compared to <a href="/menus-prices/the-works-pizza" class="text-[#cc0000] underline font-black">The Works</a>, BBQ Chicken Bacon has similar calories but noticeably less sodium because it uses only two meats (chicken and bacon) instead of three (pepperoni, sausage, Canadian bacon)</li>
</ul>
...
<ul>
<li><strong>Original Crust</strong> — best choice for delivery. The hand-tossed dough is substantial enough to absorb moisture from the BBQ sauce without becoming soggy by the time the pizza reaches you. This is the crust the pizza was designed for.</li>
...
<li><strong>New York Style</strong> — excellent for groups. Larger slices with a pliable crust make this a strong choice for sharing. The NY Style holds up better under the sauce load than Thin Crust.</li>
<li><strong>Epic Stuffed Crust</strong> — the premium choice. Mozzarella baked into the crust edge pairs surprisingly well with the BBQ flavor — the mild dairy of the crust cheese softens the sweetness of the sauce. At 400 calories per large slice, it is the most indulgent version.</li>
<li><strong>Garlic Epic Stuffed Crust</strong> — use caution. The garlic butter infused into this crust works perfectly with tomato-based pizzas but can clash slightly with the sweetness of the BBQ sauce.</li>
</ul>
...
<br/><br/>
<h2>Papa Johns BBQ Chicken Bacon vs Domino's BBQ Chicken vs Pizza Hut BBQ Chicken</h2>
<div class="overflow-x-auto mt-4">
<table>
<thead>
...
<p class="mt-4"><strong>The verdict:</strong> At $20.99 for a Large, BBQ Chicken Bacon Pizza is the same price as <a href="/menus-prices/the-works-pizza" class="text-[#cc0000] underline font-black">The Works</a> despite having fewer toppings — the premium reflects the cost of quality grilled chicken versus sausage and Canadian bacon. For customers who specifically want BBQ flavor in their pizza, it is the best option available from a major US chain in 2026. With a promo code from our <a href="/coupons" class="text-[#cc0000] underline font-black">coupons page</a>, it regularly comes down to $14–$16, which is excellent value for this ingredient quality.</p>
...
<ul>
<li>Request extra red onions at no extra charge — they make the pizza significantly brighter in flavor</li>
...
<li><a href="/menus-prices/the-works-pizza" class="text-[#cc0000] underline font-black">Papa Johns The Works Pizza — Toppings, Price & Honest Review</a></li>
    ...
    "allergens": [
        {
            "name": "Milk",
            "present": true,
            "note": "Contains 100% real mozzarella cheese."
        },
        {
            "name": "Wheat",
            "present": true,
            "note": "Original dough is wheat-based."
        },
        {
            "name": "Soy",
            "present": true,
            "note": "Soybean oil used in dough and BBQ sauce."
        },
        {
            "name": "Pork",
            "present": true,
            "note": "Contains hickory-smoked bacon (pork). No other pork products."
        },
        {
            "name": "Eggs",
            "present": false,
            "note": "No egg in standard ingredients."
        }
    ],
    "sizes": [
        {
            "size": "Small (10\") Original Crust",
            "price": 14.49
        },
        {
            "size": "Medium (12\") Original Crust",
            "price": 17.49
        },
        {
            "size": "Large (14\") Original Crust",
            "price": 20.99
        },
        {
            "size": "Extra Large (16\") Original Crust",
            "price": 23.99
        },
        {
            "size": "Large Epic Stuffed Crust",
            "price": 23.99
        },
        {
            "size": "Large Garlic Epic Stuffed Crust",
            "price": 24.49
        },
        {
            "size": "Large Crispy Thin Crust",
            "price": 20.99
        },
        {
            "size": "Small Gluten-Free Crust",
            "price": 16.49
        },
        {
            "size": "Extra Chicken",
        ...
        {
            "size": "Ranch Dipping Sauce",
            "price": 0.85
        },
        {
            "size": "Extra BBQ Sauce",
            "price": 0.85
        }
    ],
    "faqs": [
...
if (existingIndex !== -1) {
    ...
    console.log('BBQ Chicken Bacon Pizza article updated successfully!');
} else {
    data.push(newItem);
    console.log('BBQ Chicken Bacon Pizza article added successfully!');
}

fs.writeFileSync(menuPath, JSON.stringify(data, null, 4));
console.log('menu-items.json saved! URL will be: /menus-prices/bbq-chicken-bacon-pizza');
