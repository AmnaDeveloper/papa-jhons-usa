        ...
        <div className="bg-[#fcfaf8] min-h-screen font-sans pb-20">
            ...
            <section id="pizza-menu" className="max-w-[1280px] mx-auto px-4 mb-24">
                 <div className="text-center mb-14">
                    ...
                    <div className="text-lg text-gray-700 font-medium max-w-4xl mx-auto mb-10 space-y-6 text-center leading-relaxed">
                        <p>
                            Welcome to the most complete <Link href="/" className="text-[#cc0000] underline font-black">Papa Johns menu with prices guide</Link> for the USA — updated April 2026. Whether you're looking for the price of a <Link href="/menus-prices/pepperoni-pizza" className="text-[#cc0000] underline font-black">Large Pepperoni Pizza</Link>, the calorie count on <Link href="/posts/papa-johns-garlic-knots" className="text-[#cc0000] underline font-black">Garlic Knots</Link>, or the exact toppings on <Link href="/menus-prices/the-works-pizza" className="text-[#cc0000] underline font-black">The Works</Link>, every answer is on this page. We cover all eight menu categories — <Link href="/posts/classic-pizzas" className="text-[#cc0000] underline font-black">Classic Pizzas</Link>, <Link href="/posts/super-loaded" className="text-[#cc0000] underline font-black">Super Loaded Specialty Pizzas</Link>, <Link href="/menus-prices/philly-cheesesteak-papadia" className="text-[#cc0000] underline font-black">Papadias</Link>, <Link href="/posts/sides" className="text-[#cc0000] underline font-black">Sides & Dips</Link>, Desserts, Pastas, Drinks, and the Junior Menu — with verified 2026 prices, per-slice calorie counts, allergen information, and direct ordering links.
                        </p>
                        <p>
                            Prices at Papa Johns vary slightly by location across the United States. A Large Pepperoni Pizza starts at $17.99 in most markets, while specialty pizzas like The Works begin at $20.99. Every price listed on this page reflects the current national standard for April 2026, with regional variation noted where applicable. To save on any order, check our <Link href="/coupons" className="text-[#cc0000] underline font-black">Papa Johns Coupons page</Link> — updated daily with verified deals. Earn free food on every order by joining <Link href="/papa-johns-rewards" className="text-[#cc0000] underline font-black">Papa Rewards</Link>, the chain's free loyalty program. Find your nearest location instantly using our <Link href="/store-locator" className="text-[#cc0000] underline font-black">Store Locator</Link>.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                    ...
                    {/* 7th Item Added Manually per request */}
                    <Link 
                        href="/posts/papa-johns-garlic-knots"
                        className="bg-white rounded-[2rem] p-6 shadow-sm border-2 border-gray-50 hover:border-[#CCEE18] hover:shadow-xl transition-all group flex flex-col relative overflow-hidden"
                    >
                        <div className="absolute top-0 right-0 w-24 h-24 bg-[#CCEE18] rounded-bl-full -mr-12 -mt-12 opacity-0 group-hover:opacity-10 transition-opacity"></div>
                        <div className="h-48 w-full bg-[#fcfaf8] rounded-2xl mb-5 relative overflow-hidden border border-gray-100 shadow-inner group-hover:shadow-md transition-shadow flex items-center justify-center">
                            <img src="/delicious-sides-and-dips.png" alt="Papa Johns Garlic Knots" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
                        </div>
                        <div className="flex items-center justify-between mb-3 text-left">
                            <span className="bg-[#1A3D17] text-[#CCEE18] font-black text-[9px] px-3 py-1 rounded-full uppercase tracking-widest">Sides & Dips</span>
                            <div className="flex items-center gap-1 text-yellow-500 text-[10px] font-black"><Star size={10} fill="currentColor" /> 4.7</div>
                        ...
                        <h3 className="text-xl font-black text-[#1A3D17] uppercase leading-tight mb-4 group-hover:text-[#cc0000] transition-colors text-left" style={{ fontFamily: '"PapaSans-Heavy", sans-serif' }}>
                            Papa Johns Garlic Knots
                        </h3>
                        <div className="mt-auto pt-4 border-t border-gray-50 flex items-center justify-between">
                            <div className="flex flex-col text-left">
                                <span className="text-gray-400 text-[9px] font-bold uppercase tracking-widest leading-none mb-1">Price from</span>
                                <span className="text-xl font-black text-[#1A3D17] group-hover:text-[#cc0000] transition-colors">$6.99</span>
                            </div>
                            <div className="bg-[#CCEE18] p-2.5 rounded-full group-hover:bg-[#cc0000] group-hover:text-white transition-colors">
                                <ArrowRight size={18} className="group-hover:translate-x-0.5 transition-transform" />
                            </div>
