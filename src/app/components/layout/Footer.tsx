...
export default function Footer() {
    ...
    return (
        <footer className="font-sans">
            <div className="bg-[#e8dcce] text-[#121827]">
            ...
            <div className="bg-[#16071b] text-[#9b91a3]">
                <div className="mx-auto max-w-[1440px] px-6 py-8 md:px-10 lg:px-16">
                    <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-3">
                        <div className="flex flex-wrap items-center justify-center gap-5 text-sm font-semibold md:justify-start">
                            ...
                            <span className="hidden h-4 w-px bg-[#56465e] sm:block" aria-hidden="true" />
                        ...
                        <div className="flex justify-center gap-4">
                            {socialLinks.map((link) => (
                                <a
                                    ...
                                    className="flex h-11 w-11 items-center justify-center rounded-full bg-white/10 text-sm font-black uppercase text-[#c7bdcc] transition-colors hover:bg-[#CCEE18] hover:text-[#16071b]"
                                >
                                    {link.text}
                                </a>
                            ))}
                    ...
                    <p className="mt-8 text-center text-sm font-semibold leading-relaxed text-[#827788]">
