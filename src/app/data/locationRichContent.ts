...
export const locationRichContent: Record<string, RichLocationData> = {
    "albuquerque-nm": {
        ...
        metaDesc: "Papa Johns Albuquerque, NM — 2026 menu price guide, all Albuquerque locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Albuquerque now.",
        h1: "Papa John's Albuquerque, NM — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Albuquerque, New Mexico? This guide covers the Papa Johns menu price guide for Albuquerque — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Albuquerque Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Old Town, or anywhere across Albuquerque, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Albuquerque?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." }
        ],
        schema: {
    ...
    "anchorage-ak": {
        ...
        metaDesc: "Papa Johns Anchorage, AK — 2026 menu price guide, all Anchorage locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Anchorage now.",
        h1: "Papa John's Anchorage, AK — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Anchorage, Alaska? This guide covers the Papa Johns menu price guide for Anchorage — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Anchorage Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Fairview, or anywhere across Anchorage, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Anchorage?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." }
        ],
        schema: {
          "@context": "https://schema.org",
          "@type": "FastFoodRestaurant",
    ...
    "atlanta-ga": {
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Atlanta?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. The Papa Pairings deal allows two qualifying medium items for $6.99 each — the best value option. Check the coupons page for current Atlanta deals and promo codes." },
    ...
    "austin-tx": {
        ...
        metaDesc: "Papa Johns Austin TX — 2026 menu price guide, all 12 Austin locations, delivery areas, hours & exclusive Austin deals. Order online or find a store near you.",
        h1: "Papa John's Austin TX — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Austin, TX? You are in the right place. This page covers the Papa Johns menu price guide for Austin — including popular pizzas, sides, desserts, and drinks to compare in 2026 — plus all 12 Papa Johns locations across Austin with listed addresses to verify, phone numbers, and hours.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Austin?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." }
        ],
        schema: {
          "@context": "https://schema.org",
          "@type": "FastFoodRestaurant",
    ...
    "san-antonio-tx": {
        ...
        intro: "Ordering Papa Johns in San Antonio is not just a question of picking a pizza. The city stretches from downtown and Southtown to Alamo Heights, Stone Oak, Leon Valley, UTSA, and the Far West Side, so the best store, delivery time, and final price can change based on your address.\n\nThis independent guide is built to help San Antonio readers plan a better order before checkout: current menu price ranges, popular pizzas, carryout versus delivery advice, neighborhood timing notes, event-night tips, and the safest way to verify the assigned Papa Johns location serving your address. We do not publish a fake local phone number or pretend one downtown store serves the entire city. Always confirm live availability, hours, and final checkout prices in the official Papa Johns app or website before paying.",
        stats: {
        ...
        faq: [
            { q: "Where is Papa Johns in San Antonio, Texas?", a: "Papa Johns has service areas across San Antonio, but the correct store depends on your address. Enter your street address in the official Papa Johns app or website to see the assigned delivery or carryout location." },
    ...
    "san-diego-ca": {
        ...
        faq: [
            { q: "Where is Papa Johns in San Diego, California?", a: "Papa Johns service in San Diego depends on your address. Enter your street address in the official Papa Johns app or website to see the assigned delivery or carryout store." },
    ...
    "san-francisco-ca": {
        ...
        faq: [
            { q: "Where is Papa Johns in San Francisco, California?", a: "Papa Johns service in San Francisco depends on your address. Enter your street address in the official Papa Johns app or website to see the assigned delivery or carryout store." },
            ...
            { q: "Does Papa Johns deliver to the Mission or SoMa?", a: "Delivery availability depends on the address and assigned store. Dense apartment access, one-way streets, and dinner rush timing can affect delivery estimates in both areas." },
    ...
    "san-jose-ca": {
        ...
        neighborhoodContent: [
            ...
            },
            {
                ...
                text: "Orders near San Jose Mineta International Airport, airport hotels, and business-travel corridors need clear delivery instructions. Add the hotel name, room number, lobby preference, company name, or front-desk note before checkout. If you are ordering after a late flight or long workday, confirm typical store-hour notes in the official ordering flow before relying on a city-level hours estimate. Carryout may be easier for nearby hotels with shuttle or rideshare access, while delivery is better when parking or lobby access is difficult."
            },
            {
        ...
        faq: [
            { q: "Where is Papa Johns in San Jose, California?", a: "Papa Johns service in San Jose depends on your address. Enter your street address in the official Papa Johns app or website to see the assigned delivery or carryout store." },
            { q: "Does Papa Johns deliver near San Jose State University?", a: "Delivery may be available near San Jose State, but availability depends on the address and assigned store. Add clear building, dorm, apartment, or lobby instructions at checkout." },
    ...
    "jacksonville-fl": {
        ...
        faq: [
            { q: "Where is Papa Johns in Jacksonville, Florida?", a: "Papa Johns service in Jacksonville depends on your address. Enter your street address in the official Papa Johns app or website to see the assigned delivery or carryout store." },
            { q: "Does Papa Johns deliver to Jacksonville Beach?", a: "Delivery may be available to many Jacksonville Beach and coastal addresses, but availability depends on the address and assigned store. Beach traffic and parking can affect delivery timing." },
    ...
    "seattle-wa": {
        ...
        faq: [
            { q: "Where is Papa Johns in Seattle, Washington?", a: "Papa Johns service in Seattle depends on your address. Enter your street address in the official Papa Johns app or website to see the assigned delivery or carryout store." },
            ...
            { q: "Does Papa Johns deliver to the University District?", a: "Delivery availability depends on the address and assigned store. Student housing and campus-area orders can get busy during dinner, weekends, and school events." },
    ...
    "washington-dc": {
        ...
        faq: [
            { q: "Where is Papa Johns in Washington, DC?", a: "Papa Johns service in Washington, DC depends on your address. Enter your street address in the official Papa Johns app or website to see the assigned delivery or carryout store." },
            ...
            { q: "Does Papa Johns deliver near Capitol Hill or Navy Yard?", a: "Delivery availability depends on the address and assigned store. Event traffic near Capitol Hill, Navy Yard, and Nationals Park can increase delivery times." },
    ...
    "baltimore-md": {
        ...
        faq: [
            ...
            { q: "Does Papa Johns deliver to Federal Hill and the Inner Harbor?", a: "Papa Johns delivery coverage depends on the address entered at checkout. The S Hanover St location is positioned for Federal Hill, Riverside, Locust Point, South Baltimore, and nearby downtown areas, but the official app is the final source for delivery eligibility." },
    ...
    "billings-mt": {
        ...
        metaDesc: "Papa Johns Billings, MT — 2026 menu price guide, all Billings locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Billings now.",
        h1: "Papa John's Billings, MT — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Billings, Montana? This guide covers the Papa Johns menu price guide for Billings — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Billings Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, North Side, or anywhere across Billings, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Billings?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." }
        ],
        schema: {
          "@context": "https://schema.org",
          "@type": "FastFoodRestaurant",
    ...
    "birmingham-al": {
        ...
        metaDesc: "Papa Johns Birmingham, AL — 2026 menu price guide, all Birmingham locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Birmingham now.",
        h1: "Papa John's Birmingham, AL — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Birmingham, Alabama? This guide covers the Papa Johns menu price guide for Birmingham — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Birmingham Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Southside, or anywhere across Birmingham, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Birmingham?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." }
        ],
        schema: {
          "@context": "https://schema.org",
          "@type": "FastFoodRestaurant",
    ...
    "boise-id": {
        ...
        metaDesc: "Papa Johns Boise, ID — 2026 menu price guide, all Boise locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Boise now.",
        h1: "Papa John's Boise, ID — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Boise, Idaho? This guide covers the Papa Johns menu price guide for Boise — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Boise Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, North End, or anywhere across Boise, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Boise?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." }
        ],
        schema: {
          "@context": "https://schema.org",
          "@type": "FastFoodRestaurant",
    ...
    "boston-ma": {
        ...
        metaDesc: "Papa Johns Boston, MA — 2026 menu price guide, all Boston locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Boston now.",
        h1: "Papa John's Boston, MA — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Boston, Massachusetts? This guide covers the Papa Johns menu price guide for Boston — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Boston Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, North End, or anywhere across Boston, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Boston?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." }
        ],
        schema: {
          "@context": "https://schema.org",
          "@type": "FastFoodRestaurant",
    ...
    "brooklyn-ny": {
        ...
        metaDesc: "Papa Johns Brooklyn, NY — 2026 menu price guide, all Brooklyn locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Brooklyn now.",
        h1: "Papa John's Brooklyn, NY — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Brooklyn, New York? This guide covers the Papa Johns menu price guide for Brooklyn — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Brooklyn Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Brooklyn Heights, DUMBO, or anywhere across Brooklyn, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Brooklyn?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." }
        ],
        schema: {
          "@context": "https://schema.org",
          "@type": "FastFoodRestaurant",
    ...
    "buffalo-ny": {
        ...
        metaDesc: "Papa Johns Buffalo, NY — 2026 menu price guide, all Buffalo locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Buffalo now.",
        h1: "Papa John's Buffalo, NY — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Buffalo, New York? This guide covers the Papa Johns menu price guide for Buffalo — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Buffalo Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Allentown, or anywhere across Buffalo, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Buffalo?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." }
        ],
        schema: {
          "@context": "https://schema.org",
          "@type": "FastFoodRestaurant",
    ...
    "burlington-vt": {
        ...
        metaDesc: "Papa Johns Burlington, VT — 2026 menu price guide, all Burlington locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Burlington now.",
        h1: "Papa John's Burlington, VT — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Burlington, Vermont? This guide covers the Papa Johns menu price guide for Burlington — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Burlington Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, North End, or anywhere across Burlington, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Burlington?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." }
        ],
        schema: {
          "@context": "https://schema.org",
          "@type": "FastFoodRestaurant",
    ...
    "charleston-wv": {
        ...
        metaDesc: "Papa Johns Charleston, WV — 2026 menu price guide, all Charleston locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Charleston now.",
        h1: "Papa John's Charleston, WV — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Charleston, West Virginia? This guide covers the Papa Johns menu price guide for Charleston — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Charleston Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Kanawha City, or anywhere across Charleston, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
    ...
    "charlotte-nc": {
        ...
        metaDesc: "Papa Johns Charlotte, NC — 2026 menu price guide, all Charlotte locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Charlotte now.",
        h1: "Papa John's Charlotte, NC — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Charlotte, North Carolina? This guide covers the Papa Johns menu price guide for Charlotte — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Charlotte Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Uptown, South End, or anywhere across Charlotte, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        neighborhoodContent: [
            ...
            {
                title: "Charlotte Game Night and Uptown Ordering Notes",
                text: "Uptown Charlotte can get busy around Panthers, Hornets, concert, and convention traffic. If you are ordering near Bank of America Stadium, Spectrum Center, or a hotel around Tryon Street, compare carryout and delivery before paying because parking, lobby access, and event surges can change the real wait time. For group orders, build the cart early and confirm the final delivery estimate in the official Papa Johns checkout."
            },
            {
                title: "Carryout Versus Delivery in South End and Dilworth",
                text: "South End, Dilworth, Elizabeth, and Plaza Midwood customers may see different fees and delivery windows depending on the assigned store and time of day. Carryout can be worth checking when traffic is heavy on South Boulevard or when apartment access adds extra handoff time. Use this page for planning, then verify store assignment, hours, and final price in the official locator or checkout flow."
            }
        ],
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Charlotte?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." }
        ],
        schema: {
          "@context": "https://schema.org",
          "@type": "FastFoodRestaurant",
    ...
    "cheyenne-wy": {
        ...
        metaDesc: "Papa Johns Cheyenne, WY — 2026 menu price guide, all Cheyenne locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Cheyenne now.",
        h1: "Papa John's Cheyenne, WY — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Cheyenne, Wyoming? This guide covers the Papa Johns menu price guide for Cheyenne — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Cheyenne Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, East Cheyenne, or anywhere across Cheyenne, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Cheyenne?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "chicago-il": {
        ...
        metaDesc: "Papa Johns Chicago, IL — 2026 menu price guide, all Chicago locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Chicago now.",
        h1: "Papa John's Chicago, IL — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Chicago, Illinois? This guide covers the Papa Johns menu price guide for Chicago — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Chicago Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to The Loop, Streeterville, or anywhere across Chicago, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Chicago?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "cleveland-oh": {
        ...
        metaDesc: "Papa Johns Cleveland, OH — 2026 menu price guide, all Cleveland locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Cleveland now.",
        h1: "Papa John's Cleveland, OH — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Cleveland, Ohio? This guide covers the Papa Johns menu price guide for Cleveland — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Cleveland Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, The Flats, or anywhere across Cleveland, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Cleveland?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "colorado-springs-co": {
        ...
        metaDesc: "Papa Johns Colorado Springs, CO — 2026 menu price guide, all Colorado Springs locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Colorado Springs now.",
        h1: "Papa John's Colorado Springs, CO — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Colorado Springs, Colorado? This guide covers the Papa Johns menu price guide for Colorado Springs — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Colorado Springs Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Westside, or anywhere across Colorado Springs, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
    ...
    "columbia-sc": {
        ...
        metaDesc: "Papa Johns Columbia, SC — 2026 menu price guide, all Columbia locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Columbia now.",
        h1: "Papa John's Columbia, SC — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Columbia, South Carolina? This guide covers the Papa Johns menu price guide for Columbia — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Columbia Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Vista Arts District, or anywhere across Columbia, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Columbia?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "columbus-oh": {
        ...
        metaDesc: "Papa Johns Columbus, OH — 2026 menu price guide, all Columbus locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Columbus now.",
        h1: "Papa John's Columbus, OH — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Columbus, Ohio? This guide covers the Papa Johns menu price guide for Columbus — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Columbus Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Discovery District, or anywhere across Columbus, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Columbus?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "dallas-tx": {
        ...
        metaDesc: "Papa Johns Dallas, TX — 2026 menu price guide, all Dallas locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Dallas now.",
        h1: "Papa John's Dallas, TX — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Dallas, Texas? This guide covers the Papa Johns menu price guide for Dallas — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Dallas Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, East Dallas, or anywhere across Dallas, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Dallas?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "denver-co": {
        ...
        metaDesc: "Papa Johns Denver, CO — 2026 menu price guide, all Denver locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Denver now.",
        h1: "Papa John's Denver, CO — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Denver, Colorado? This guide covers the Papa Johns menu price guide for Denver — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Denver Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to LoDo, Downtown, or anywhere across Denver, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Denver?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "des-moines-ia": {
        ...
        metaDesc: "Papa Johns Des Moines, IA — 2026 menu price guide, all Des Moines locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Des Moines now.",
        h1: "Papa John's Des Moines, IA — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Des Moines, Iowa? This guide covers the Papa Johns menu price guide for Des Moines — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Des Moines Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, East Village, or anywhere across Des Moines, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Des Moines?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "detroit-mi": {
        ...
        metaDesc: "Papa Johns Detroit, MI — 2026 menu price guide, all Detroit locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Detroit now.",
        h1: "Papa John's Detroit, MI — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Detroit, Michigan? This guide covers the Papa Johns menu price guide for Detroit — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Detroit Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Rivertown, or anywhere across Detroit, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Detroit?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "fargo-nd": {
        ...
        metaDesc: "Papa Johns Fargo, ND — 2026 menu price guide, all Fargo locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Fargo now.",
        h1: "Papa John's Fargo, ND — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Fargo, North Dakota? This guide covers the Papa Johns menu price guide for Fargo — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Fargo Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Downer, or anywhere across Fargo, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Fargo?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "grand-rapids-mi": {
        ...
        metaDesc: "Papa Johns Grand Rapids, MI — 2026 menu price guide, all Grand Rapids locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Grand Rapids now.",
        h1: "Papa John's Grand Rapids, MI — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Grand Rapids, Michigan? This guide covers the Papa Johns menu price guide for Grand Rapids — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Grand Rapids Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Monroe North, or anywhere across Grand Rapids, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Grand Rapids?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "hartford-ct": {
        ...
        metaDesc: "Papa Johns Hartford, CT — 2026 menu price guide, all Hartford locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Hartford now.",
        h1: "Papa John's Hartford, CT — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Hartford, Connecticut? This guide covers the Papa Johns menu price guide for Hartford — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Hartford Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Frog Hollow, or anywhere across Hartford, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Hartford?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "honolulu-hi": {
        ...
        metaDesc: "Papa Johns Honolulu, HI — 2026 menu price guide, all Honolulu locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Honolulu now.",
        h1: "Papa John's Honolulu, HI — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Honolulu, Hawaii? This guide covers the Papa Johns menu price guide for Honolulu — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Honolulu Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Kakaako, or anywhere across Honolulu, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Honolulu?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "houston-tx": {
        ...
        metaDesc: "Papa Johns Houston, TX — 2026 menu price guide, all Houston locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Houston now.",
        h1: "Papa John's Houston, TX — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Houston, Texas? This guide covers the Papa Johns menu price guide for Houston — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Houston Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Midtown, or anywhere across Houston, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Houston?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "indianapolis-in": {
        ...
        metaDesc: "Papa Johns Indianapolis, IN — 2026 menu price guide, all Indianapolis locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Indianapolis now.",
        h1: "Papa John's Indianapolis, IN — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Indianapolis, Indiana? This guide covers the Papa Johns menu price guide for Indianapolis — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Indianapolis Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Military Park, or anywhere across Indianapolis, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Indianapolis?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "jackson-ms": {
        ...
        metaDesc: "Papa Johns Jackson, MS — 2026 menu price guide, all Jackson locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Jackson now.",
        h1: "Papa John's Jackson, MS — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Jackson, Mississippi? This guide covers the Papa Johns menu price guide for Jackson — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Jackson Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Capital Complex, or anywhere across Jackson, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Jackson?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "kansas-city-mo": {
        ...
        metaDesc: "Papa Johns Kansas City, MO — 2026 menu price guide, all Kansas City locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Kansas City now.",
        h1: "Papa John's Kansas City, MO — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Kansas City, Missouri? This guide covers the Papa Johns menu price guide for Kansas City — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Kansas City Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Quality Hill, or anywhere across Kansas City, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Kansas City?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "knoxville-tn": {
        ...
        metaDesc: "Papa Johns Knoxville, TN — 2026 menu price guide, all Knoxville locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Knoxville now.",
        h1: "Papa John's Knoxville, TN — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Knoxville, Tennessee? This guide covers the Papa Johns menu price guide for Knoxville — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Knoxville Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Kingston Pike corridor, Bearden, or anywhere across Knoxville, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Knoxville?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "las-vegas-nv": {
        ...
        metaDesc: "Papa Johns Las Vegas, NV — 2026 menu price guide, all Las Vegas locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Las Vegas now.",
        h1: "Papa John's Las Vegas, NV — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Las Vegas, Nevada? This guide covers the Papa Johns menu price guide for Las Vegas — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Las Vegas Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to The Strip, Paradise, or anywhere across Las Vegas, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Las Vegas?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "little-rock-ar": {
        ...
        metaDesc: "Papa Johns Little Rock, AR — 2026 menu price guide, all Little Rock locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Little Rock now.",
        h1: "Papa John's Little Rock, AR — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Little Rock, Arkansas? This guide covers the Papa Johns menu price guide for Little Rock — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Little Rock Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, River Market, or anywhere across Little Rock, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Little Rock?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "los-angeles-ca": {
        ...
        metaDesc: "Papa Johns Los Angeles, CA — 2026 menu price guide, all Los Angeles locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Los Angeles now.",
        h1: "Papa John's Los Angeles, CA — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Los Angeles, California? This guide covers the Papa Johns menu price guide for Los Angeles — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Los Angeles Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Hollywood, Los Feliz, or anywhere across Los Angeles, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Los Angeles?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "louisville-ky": {
        ...
        metaDesc: "Papa Johns Louisville, KY — 2026 menu price guide, all Louisville locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Louisville now.",
        h1: "Papa John's Louisville, KY — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Louisville, Kentucky? This guide covers the Papa Johns menu price guide for Louisville — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Louisville Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Old Louisville, or anywhere across Louisville, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Louisville?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "manchester-nh": {
        ...
        metaDesc: "Papa Johns Manchester, NH — 2026 menu price guide, all Manchester locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Manchester now.",
        h1: "Papa John's Manchester, NH — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Manchester, New Hampshire? This guide covers the Papa Johns menu price guide for Manchester — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Manchester Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Millyard, or anywhere across Manchester, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Manchester?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "memphis-tn": {
        ...
        metaDesc: "Papa Johns Memphis, TN — 2026 menu price guide, all Memphis locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Memphis now.",
        h1: "Papa John's Memphis, TN — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Memphis, Tennessee? This guide covers the Papa Johns menu price guide for Memphis — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Memphis Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to US-64 corridor, Bartlett border, or anywhere across Memphis, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Memphis?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "milwaukee-wi": {
        ...
        metaDesc: "Papa Johns Milwaukee, WI — 2026 menu price guide, all Milwaukee locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Milwaukee now.",
        h1: "Papa John's Milwaukee, WI — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Milwaukee, Wisconsin? This guide covers the Papa Johns menu price guide for Milwaukee — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Milwaukee Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, East Town, or anywhere across Milwaukee, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Milwaukee?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "minneapolis-mn": {
        ...
        metaDesc: "Papa Johns Minneapolis, MN — 2026 menu price guide, all Minneapolis locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Minneapolis now.",
        h1: "Papa John's Minneapolis, MN — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Minneapolis, Minnesota? This guide covers the Papa Johns menu price guide for Minneapolis — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Minneapolis Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, North Loop, or anywhere across Minneapolis, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
    ...
    "montgomery-al": {
        ...
        metaDesc: "Papa Johns Montgomery, AL — 2026 menu price guide, all Montgomery locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Montgomery now.",
        h1: "Papa John's Montgomery, AL — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Montgomery, Alabama? This guide covers the Papa Johns menu price guide for Montgomery — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Montgomery Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Capitol Hill, or anywhere across Montgomery, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Montgomery?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "naperville-il": {
        ...
        metaDesc: "Papa Johns Naperville, IL — 2026 menu price guide, all Naperville locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Naperville now.",
        h1: "Papa John's Naperville, IL — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Naperville, Illinois? This guide covers the Papa Johns menu price guide for Naperville — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Naperville Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown Naperville, Riverwalk area, or anywhere across Naperville, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Naperville?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "nashville-tn": {
        ...
        metaDesc: "Papa Johns Nashville, TN — 2026 menu price guide, all Nashville locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Nashville now.",
        h1: "Papa John's Nashville, TN — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Nashville, Tennessee? This guide covers the Papa Johns menu price guide for Nashville — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Nashville Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Antioch, Hickory Hollow, or anywhere across Nashville, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Nashville?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "new-orleans-la": {
        ...
        metaDesc: "Papa Johns New Orleans, LA — 2026 menu price guide, all New Orleans locations, delivery areas, hours & local deals. Find the nearest Papa Johns in New Orleans now.",
        h1: "Papa John's New Orleans, LA — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in New Orleans, Louisiana? This guide covers the Papa Johns menu price guide for New Orleans — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the New Orleans Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to CBD, French Quarter, or anywhere across New Orleans, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in New Orleans?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "new-york-ny": {
        ...
        metaDesc: "Papa Johns New York, NY — 2026 menu price guide, all New York locations, delivery areas, hours & local deals. Find the nearest Papa Johns in New York now.",
        h1: "Papa John's New York, NY — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in New York, New York? This guide covers the Papa Johns menu price guide for New York — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the New York Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Midtown, Murray Hill, or anywhere across New York, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in New York?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "newark-nj": {
        ...
        metaDesc: "Papa Johns Newark, NJ — 2026 menu price guide, all Newark locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Newark now.",
        h1: "Papa John's Newark, NJ — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Newark, New Jersey? This guide covers the Papa Johns menu price guide for Newark — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Newark Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Ironbound area, or anywhere across Newark, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Newark?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "oklahoma-city-ok": {
        ...
        metaDesc: "Papa Johns Oklahoma City, OK — 2026 menu price guide, all Oklahoma City locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Oklahoma City now.",
        h1: "Papa John's Oklahoma City, OK — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Oklahoma City, Oklahoma? This guide covers the Papa Johns menu price guide for Oklahoma City — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Oklahoma City Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Bricktown, or anywhere across Oklahoma City, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Oklahoma City?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "omaha-ne": {
        ...
        metaDesc: "Papa Johns Omaha, NE — 2026 menu price guide, all Omaha locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Omaha now.",
        h1: "Papa John's Omaha, NE — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Omaha, Nebraska? This guide covers the Papa Johns menu price guide for Omaha — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Omaha Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Near Downtown, Midtown, or anywhere across Omaha, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Omaha?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "orlando-fl": {
        ...
        metaDesc: "Papa Johns Orlando, FL — 2026 menu price guide, all Orlando locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Orlando now.",
        h1: "Papa John's Orlando, FL — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Orlando, Florida? This guide covers the Papa Johns menu price guide for Orlando — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Orlando Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Thornton Park, or anywhere across Orlando, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Orlando?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "philadelphia-pa": {
        ...
        metaDesc: "Papa Johns Philadelphia, PA — 2026 menu price guide, all Philadelphia locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Philadelphia now.",
        h1: "Papa John's Philadelphia, PA — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Philadelphia, Pennsylvania? This guide covers the Papa Johns menu price guide for Philadelphia — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Philadelphia Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Center City, Rittenhouse Square, or anywhere across Philadelphia, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Philadelphia?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "phoenix-az": {
        ...
        metaDesc: "Papa Johns Phoenix, AZ — 2026 menu price guide, all Phoenix locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Phoenix now.",
        h1: "Papa John's Phoenix, AZ — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Phoenix, Arizona? This guide covers the Papa Johns menu price guide for Phoenix — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Phoenix Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, Central City, or anywhere across Phoenix, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Phoenix?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "pittsburgh-pa": {
        ...
        metaDesc: "Papa Johns Pittsburgh, PA — 2026 menu price guide, all Pittsburgh locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Pittsburgh now.",
        h1: "Papa John's Pittsburgh, PA — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Pittsburgh, Pennsylvania? This guide covers the Papa Johns menu price guide for Pittsburgh — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Pittsburgh Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Downtown, North Shore, or anywhere across Pittsburgh, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Pittsburgh?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "portland-me": {
        ...
        metaDesc: "Papa Johns Portland, ME — 2026 menu price guide, all Portland locations, delivery areas, hours & local deals. Find the nearest Papa Johns in Portland now.",
        h1: "Papa John's Portland, ME — Menu, Prices & Locations (2026)",
        intro: "Looking for Papa John's in Portland, Maine? This guide covers the Papa Johns menu price guide for Portland — popular pizzas, sides, desserts, and drinks to compare in 2026 — plus the Portland Papa Johns location with city-level ordering notes, typical hours reminders, and links to confirm current store details. Whether you are ordering delivery to Bayside, East End, or anywhere across Portland, this page has everything you need before you order.\n\nPrice examples can vary by store, deal, tax, and delivery type, so confirm the final total in the official Papa Johns checkout before ordering. For the fastest ordering experience, use the Papa Johns app — it includes Papa Track real-time order tracking from dough prep through your door.",
        stats: {
            deliveryTime: "30–45 min",
            startingPrice: "$17.99",
            verifiedYear: "2026"
        ...
        faq: [
            ...
            { q: "What is the cheapest Papa Johns pizza in Portland?", a: "A Small Cheese or Pepperoni Pizza may start around $11.49. Under the Papa Pairings deal, two qualifying items may appear around $6.99 each when that offer is active. Visit our [Papa Johns Coupons](https://papajohns-menus.us/coupons) page for coupon examples, then confirm live offers in checkout." },
    ...
    "fort-worth-tx": {
        ...
        faq: [
            { q: "Where is Papa Johns in Fort Worth, TX?", a: "This Fort Worth guide uses the listed location at 2212 Main St, Fort Worth, TX 76102. check the official Papa Johns locator or check the official Papa Johns app to confirm the nearest active store for your address." },
            { q: "Does Papa Johns deliver in Fort Worth?", a: "Yes, Papa Johns offers delivery in Fort Worth, but delivery coverage depends on your address. Common service areas include Downtown Fort Worth, Near Southside, West 7th, the TCU area, the Cultural District, and nearby neighborhoods. Enter your address in the official app for final confirmation." },
    ...
    "portland-or": {
        ...
        faq: [
            { q: "Where is Papa Johns in Portland, OR?", a: "Use the official Papa Johns app or website to confirm the active Portland-area store assigned to your address. Store coverage can change by delivery zone, carryout availability, and franchise routing." },
    ...
    "tampa-fl": {
        ...
        faq: [
            ...
            { q: "Does Papa Johns deliver in Downtown Tampa?", a: "Yes, Papa Johns delivery is generally available in Downtown Tampa, Channelside, Water Street, Ybor City, Hyde Park, USF-area neighborhoods, and nearby communities, depending on address and store routing." },
    ...
    "sacramento-ca": {
        ...
        faq: [
            ...
            { q: "Does Papa Johns deliver in Downtown Sacramento?", a: "Yes, Papa Johns delivery is generally available in Downtown Sacramento, Midtown, Mansion Flats, Alkali Flat, Land Park, Sacramento State-area neighborhoods, and nearby communities depending on address." },
